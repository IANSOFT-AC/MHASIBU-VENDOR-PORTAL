...
class TendersController extends Controller
{
    ...
    {
        $service = Yii::$app->params['ServiceName']['tenderCard'];
    ...
    public function actionList()
    {
        ...
        if (is_array($results)) {
            foreach ($results as $kin) {
                ...
                $viewLink = Html::a('<i class="fas fa-eye"></i>', ['view', 'Key' => $kin->Key], ['class' => 'update btn btn-info btn-md', 'title' => 'View Tender.']);
                ...
                $result['data'][] = [
                    ...
                    'Current_Budget' => !empty($kin->Current_Budget) ? $kin->Current_Budget : '',
                    'Supplier_Category' => !empty($kin->Supplier_Category) ? $kin->Supplier_Category : '',
                    'Tender_Opening_Date' => !empty($kin->Tender_Opening_Date) ? $kin->Tender_Opening_Date : '',
